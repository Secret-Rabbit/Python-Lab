...
for unique_part in unique_parts:
    ...
    if os.path.isfile(file_path1) and os.path.isfile(file_path2):
        ...
        if result:
            ...
            logs += f"\nFile «{unique_part}» was deleted in the secondary directory, as it is a similar file in the primary directory"
    else:
        logs += f"\nФайл {unique_part}  was not found in one of the directories"
